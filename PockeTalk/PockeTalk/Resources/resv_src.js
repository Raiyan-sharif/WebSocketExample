...
/**
 * @license ResponsiveVoice JS v1.8.2
 *
  ...
  var ResponsiveVoice = function () {
    ...
    self.responsivevoices = [
      ...
      },
      {
        ...
        lang: "en-US",
        voiceIDs: [
          432, 433, 434, 40, 41, 42, 383, 205, 204, 43, 481, 173, 235, 283, 339,
          408, 44,
        ],
      },
      {
      ...
      },
      {
        ...
        lang: "zh-TW",
        voiceIDs: [
          469, 194, 233, 253, 254, 305, 322, 361, 384, 319, 336, 375, 409, 255,
        ],
      },
      {
      ...
      },
      {
        ...
        lang: "fr-FR",
        voiceIDs: [
          240, 21, 22, 23, 77, 178, 279, 210, 493, 266, 295, 351, 304, 321, 360,
          26,
        ],
      },
      {
    ...
    self.voicecollection = [
...

      {
        ...
        gender: "male",
        deprecated: true,
      }, //160 Finnish Male fallback. Deprecated due to RES-313

      {
        ...
        gender: "male",
        deprecated: true,
      }, //161 Czech Male fallback. Deprecated due to RES-313

      {
        ...
        gender: "male",
        deprecated: true,
      }, //162 Danish Male fallback. Deprecated due to RES-313

      {
        ...
        gender: "male",
        deprecated: true,
      }, //163 Greek Male fallback. Deprecated due to RES-313

      {
        ...
        gender: "male",
        deprecated: true,
      }, //164 Hungarian Male fallback. Deprecated due to RES-313.
...

      {
        ...
        gender: "male",
        deprecated: true,
      }, //167 Slovak Male fallback. Deprecated due to RES-313.
      ...
      { name: "Microsoft Paulina Desktop - Polish (Poland)", lang: "pl-PL" }, //352 like 296, 267 Female
      {
        ...
        lang: "zh-CN",
      }, //353 like 297, 268 Female
      {
        name: "Microsoft Yaoyao Desktop - Chinese (Simplified, PRC)",
        lang: "zh-CN",
      }, //354 like 298, 269 Female
      {
        name: "Microsoft Tracy Desktop - Chinese (Traditional, Hong Kong S.A.R.)",
        lang: "zh-CN",
      }, //355 like 299, 270 Fenale
      ...
      { name: "Microsoft Pavel Desktop - Russian (Russia)", lang: "ru-RU" }, //372 like 333, 316 Male
      {
        ...
        lang: "zh-CN",
      }, //373 like 334, 317 Male
      {
        name: "Microsoft Danny Desktop - Chinese (Traditional, Hong Kong S.A.R.)",
        lang: "zh-HK",
      }, //374 like 335, 318 Male
      {
      ...
      }, //386 Australian Male fallback
      {
        ...
        gender: "male",
        deprecated: true,
      }, //387 Russian Male fallback. Deprecated due to RES-313.
      {
      ...
      }, //398 Polish Male fallback
      {
        ...
        gender: "male",
        deprecated: true,
      }, //399 Brazilian Portuguese Male fallback. Deprecated due to RES-313.
      {
      ...
      }, //400 Portuguese Male fallback
      {
        ...
        gender: "male",
        deprecated: true,
      }, //401 Spanish Male fallback. Deprecated due to RES-313.
      {
        ...
        service: "g3",
        gender: "male",
      }, //402 Spanish (Latin American) Male fallback
      {
      ...
      }, //404 Turkish Male fallback
      {
        ...
        service: "g1",
        gender: "female",
      }, //405 Vietnamese Female fallback
      {
      ...
      }, //406 Italian Male fallback
      {
        ...
        service: "g3",
        gender: "male",
      }, //407 Dutch Male fallback
      {
        name: "Microsoft Anna - English (United States)",
        lang: "en-US",
        gender: "female",
      }, //408 Windows 7 default US English Female
      {
        name: "Microsoft Lili - Chinese (China)",
        lang: "zh-CN",
        gender: "female",
      }, //409 Windows 7 default Chinese Female
...

      {
        ...
        lang: "en-US",
        gender: "male",
      }, //431 Microsoft Edge 77.0.189.3 (Official build) dev (64-bit) US Male
      {
        name: "Microsoft Server Speech Text to Speech Voice (en-US, Jessa24kRUS)",
        lang: "en-US",
        gender: "female",
      }, //432 Microsoft Edge 77.0.189.3 (Official build) dev (64-bit) US Female
      {
        name: "Microsoft Server Speech Text to Speech Voice (en-US, JessaRUS)",
        lang: "en-US",
        gender: "female",
      }, //433 Microsoft Edge 77.0.189.3 (Official build) dev (64-bit) US Female
      {
        name: "Microsoft Server Speech Text to Speech Voice (en-US, ZiraRUS)",
        lang: "en-US",
        gender: "female",
      }, //434 Microsoft Edge 77.0.189.3 (Official build) dev (64-bit) US Female

      {
        ...
        service: "g3",
        gender: "female",
      }, //435 Bangla Bangladesh Female fallback
      {
        ...
        service: "g3",
        gender: "male",
      }, //436 Bangla Bangladesh Male fallback
      {
      ...
      }, //438 Filipino Male fallback
      {
        ...
        service: "g3",
        gender: "female",
      }, //439 Cambodian Khmer Female fallback - unused
      {
        ...
        service: "g3",
        gender: "male",
      }, //440 Cambodian Khmer Male fallback
      {
      ...
      }, //443 Ukrainian Female fallback
      {
        ...
        service: "g3",
        gender: "female",
      }, //444 Cantonese Hong Kong Female fallback
      {
        ...
        service: "g3",
        gender: "male",
      }, //445 Cantonese Hong Kong Male fallback
      {
      ...
      }, //446 Estonian Male fallback
      {
        ...
        service: "g3",
        gender: "female",
      }, //447 Bangla India Female fallback
      {
        ...
        service: "g3",
        gender: "male",
      }, //448 Bangla India Male fallback
      {
        ...
        service: "g3",
        gender: "female",
      }, //449 French Canadian Female fallback
      {
        ...
        service: "g3",
        gender: "male",
      }, //450 French Canadian Male fallback
      ...
      { name: "Chinese Hong Kong", lang: "zh_HK_#Hant", gender: "female" }, //464 Android 11 Chinese Hong Kong (Traditional)
      {
        ...
        lang: "tr-TR",
        gender: "male",
      }, //465 Windows 10 Microsoft Tolga Turkish
      {
        name: "Korean (South Korea)",
        voiceURI: "moz-tts:android:ko_KR",
        lang: "ko-KR",
        gender: "female",
      }, //466 Android 11 Firefox Korean (South Korea)
      {
        name: "Marathi (India)",
        voiceURI: "moz-tts:android:mr_IN",
        lang: "mr-IN",
        gender: "female",
      }, //467 Android 11 Firefox Marathi (India) - unused
      {
        name: "Russian (Russia)",
        voiceURI: "moz-tts:android:ru_RU",
        lang: "ru-RU",
        gender: "female",
      }, //468 Android 11 Firefox Russian (Russia)
      {
        name: "Chinese (Taiwan)",
        voiceURI: "moz-tts:android:zh_TW",
        lang: "zh-TW",
        gender: "female",
      }, //469 Android 11 Firefox Chinese (Taiwan)
      {
        name: "Hungarian (Hungary)",
        voiceURI: "moz-tts:android:hu_HU",
        lang: "hu-HU",
        gender: "female",
      }, //470 Android 11 Firefox Hungarian (Hungary)
      {
        name: "Thai (Thailand)",
        voiceURI: "moz-tts:android:th_TH",
        lang: "th-TH",
        gender: "female",
      }, //471 Android 11 Firefox Thai (Thailand)
      {
        name: "Urdu (Pakistan)",
        voiceURI: "moz-tts:android:ur_PK",
        lang: "ur-PK",
        gender: "female",
      }, //472 Android 11 Firefox Urdu (Pakistan) - unused
      {
        name: "Norwegian BokmÃ¥l (Norway)",
        voiceURI: "moz-tts:android:nb_NO",
        lang: "nb-NO",
        gender: "female",
      }, //473 Android 11 Firefox Norwegian BokmÃ¥l (Norway)
      {
        name: "Danish (Denmark)",
        voiceURI: "moz-tts:android:da_DK",
        lang: "da-DK",
        gender: "female",
      }, //474 Android 11 Firefox Danish (Denmark)
      {
        name: "Turkish (Turkey)",
        voiceURI: "moz-tts:android:tr_TR",
        lang: "tr-TR",
        gender: "female",
      }, //475 Android 11 Firefox Turkish (Turkey)
      {
        name: "Estonian (Estonia)",
        voiceURI: "moz-tts:android:et_EE",
        lang: "et-EE",
        gender: "male",
      }, //476 Android 11 Firefox Estonian (Estonia)
      {
        name: "Bosnian",
        voiceURI: "moz-tts:android:bs",
        lang: "bs",
        deprecated: true,
      }, //477 Android 11 Firefox Bosnian
      {
        name: "Swahili",
        voiceURI: "moz-tts:android:sw",
        lang: "sw",
        deprecated: true,
      }, //478 Android 11 Firefox Swahili
      {
        name: "Portuguese (Portugal)",
        voiceURI: "moz-tts:android:pt_PT",
        lang: "pt-PT",
        gender: "female",
      }, //479 Android 11 Firefox Portuguese (Portugal)
      {
        name: "Vietnamese (Vietnam)",
        voiceURI: "moz-tts:android:vi_VN",
        lang: "vi-VN",
        gender: "female",
      }, //480 Android 11 Firefox Vietnamese (Vietnam)
      {
        name: "English (United States)",
        voiceURI: "moz-tts:android:en_US",
        lang: "en-US",
        gender: "female",
      }, //481 Android 11 Firefox English (United States)
      {
        name: "Swedish (Sweden)",
        voiceURI: "moz-tts:android:sv_SE",
        lang: "sv-SE",
        gender: "female",
      }, //482 Android 11 Firefox Swedish (Sweden)
      {
        name: "Arabic",
        voiceURI: "moz-tts:android:ar",
        lang: "ar",
        gender: "female",
      }, //483 Android 11 Firefox Arabic
      {
        name: "Sundanese (Indonesia)",
        voiceURI: "moz-tts:android:su_ID",
        lang: "su-ID",
        gender: "female",
      }, //484 Android 11 Firefox Sundanese (Indonesia) - unused
      {
        name: "Bangla (Bangladesh)",
        voiceURI: "moz-tts:android:bn_BD",
        lang: "bn-BD",
        gender: "male",
      }, //485 Android 11 Firefox Bangla (Bangladesh)
      {
        name: "Gujarati (India)",
        voiceURI: "moz-tts:android:gu_IN",
        lang: "gu-IN",
        gender: "female",
      }, //486 Android 11 Firefox Gujarati (India) - unused
      {
        name: "Kannada (India)",
        voiceURI: "moz-tts:android:kn_IN",
        lang: "kn-IN",
        gender: "female",
      }, //487 Android 11 Firefox Kannada (India) - unused
      {
        name: "Greek (Greece)",
        voiceURI: "moz-tts:android:el_GR",
        lang: "el-GR",
        gender: "female",
      }, //488 Android 11 Firefox Greek (Greece)
      {
        name: "Hindi (India)",
        voiceURI: "moz-tts:android:hi_IN",
        lang: "hi-IN",
        gender: "female",
      }, //489 Android 11 Firefox Hindi (India)
      {
        name: "Finnish (Finland)",
        voiceURI: "moz-tts:android:fi_FI",
        lang: "fi-FI",
        gender: "female",
      }, //490 Android 11 Firefox Finnish (Finland)
      {
        name: "Khmer (Cambodia)",
        voiceURI: "moz-tts:android:km_KH",
        lang: "km-KH",
        gender: "female",
      }, //491 Android 11 Firefox Khmer (Cambodia) - unused
      {
        name: "Bangla (India)",
        voiceURI: "moz-tts:android:bn_IN",
        lang: "bn-IN",
        gender: "male",
      }, //492 Android 11 Firefox Bangla (India)
      {
        name: "French (France)",
        voiceURI: "moz-tts:android:fr_FR",
        lang: "fr-FR",
        gender: "female",
      }, //493 Android 11 Firefox French (France)
      {
        name: "Ukrainian (Ukraine)",
        voiceURI: "moz-tts:android:uk_UA",
        lang: "uk-UA",
        gender: "female",
      }, //494 Android 11 Firefox Ukrainian (Ukraine)
      {
        name: "English (Australia)",
        voiceURI: "moz-tts:android:en_AU",
        lang: "en-AU",
        gender: "female",
      }, //495 Android 11 Firefox English (Australia)
      {
        name: "Dutch (Netherlands)",
        voiceURI: "moz-tts:android:nl_NL",
        lang: "nl-NL",
        gender: "female",
      }, //496 Android 11 Firefox Dutch (Netherlands)
      {
        name: "French (Canada)",
        voiceURI: "moz-tts:android:fr_CA",
        lang: "fr-CA",
        gender: "female",
      }, //497 Android 11 Firefox French (Canada)
      {
        name: "Serbian",
        voiceURI: "moz-tts:android:sr",
        lang: "sr",
        gender: "female",
      }, //498 Android 11 Firefox Serbian - unused
      {
        name: "Portuguese (Brazil)",
        voiceURI: "moz-tts:android:pt_BR",
        lang: "pt-BR",
        gender: "female",
      }, //499 Android 11 Firefox Portuguese (Brazil)
      {
        name: "Malayalam (India)",
        voiceURI: "moz-tts:android:ml_IN",
        lang: "ml-IN",
        gender: "female",
      }, //500 Android 11 Firefox Malayalam (India) - unused
      {
        name: "Sinhala (Sri Lanka)",
        voiceURI: "moz-tts:android:si_LK",
        lang: "si-LK",
        gender: "female",
      }, //501 Android 11 Firefox Sinhala (Sri Lanka)
      {
        name: "German (Germany)",
        voiceURI: "moz-tts:android:de_DE",
        lang: "de-DE",
        gender: "female",
      }, //502 Android 11 Firefox German (Germany)
      {
        name: "Kurdish",
        voiceURI: "moz-tts:android:ku",
        lang: "ku",
        deprecated: true,
      }, //503 Android 11 Firefox Kurdish
      {
        name: "Czech (Czechia)",
        voiceURI: "moz-tts:android:cs_CZ",
        lang: "cs-CZ",
        gender: "female",
      }, //504 Android 11 Firefox Czech (Czechia)
      {
        name: "Polish (Poland)",
        voiceURI: "moz-tts:android:pl_PL",
        lang: "pl-PL",
        gender: "female",
      }, //505 Android 11 Firefox Polish (Poland)
      {
        name: "Slovak (Slovakia)",
        voiceURI: "moz-tts:android:sk_SK",
        lang: "sk-SK",
        gender: "female",
      }, //506 Android 11 Firefox Slovak (Slovakia)
      {
        name: "Filipino (Philippines)",
        voiceURI: "moz-tts:android:fil_PH",
        lang: "fil-PH",
        gender: "female",
      }, //507 Android 11 Firefox Filipino (Philippines)
      {
        name: "Italian (Italy)",
        voiceURI: "moz-tts:android:it_IT",
        lang: "it-IT",
        gender: "female",
      }, //508 Android 11 Firefox Italian (Italy)
      {
        name: "Nepali (Nepal)",
        voiceURI: "moz-tts:android:ne_NP",
        lang: "ne-NP",
        gender: "female",
      }, //509 Android 11 Firefox Nepali (Nepal)
      {
        name: "Malay (Malaysia)",
        voiceURI: "moz-tts:android:ms_MY",
        lang: "ms-MY",
        gender: "female",
      }, //510 Android 11 Firefox Malay (Malaysia) - unused
      {
        name: "Croatian",
        voiceURI: "moz-tts:android:hr",
        lang: "hr",
        deprecated: true,
      }, //511 Android 11 Firefox Croatian
      {
        name: "English (Nigeria)",
        voiceURI: "moz-tts:android:en_NG",
        lang: "en-NG",
        gender: "female",
      }, //512 Android 11 Firefox English (Nigeria) - unused
      {
        name: "Chinese (China)",
        voiceURI: "moz-tts:android:zh_CN",
        lang: "zh-CN",
        gender: "female",
      }, //513 Android 11 Firefox Chinese (China)
      {
        name: "Spanish (Spain)",
        voiceURI: "moz-tts:android:es_ES",
        lang: "es-ES",
        gender: "female",
      }, //514 Android 11 Firefox Spanish (Spain)
      {
        name: "Welsh",
        voiceURI: "moz-tts:android:cy",
        lang: "cy",
        deprecated: true,
      }, //515 Android 11 Firefox Welsh
      {
        name: "Tamil (India)",
        voiceURI: "moz-tts:android:ta_IN",
        lang: "ta-IN",
        gender: "female",
      }, //516 Android 11 Firefox Tamil (India)
      {
        name: "Japanese (Japan)",
        voiceURI: "moz-tts:android:ja_JP",
        lang: "ja-JP",
        gender: "female",
      }, //517 Android 11 Firefox Japanese (Japan)
      {
        name: "Albanian",
        voiceURI: "moz-tts:android:sq",
        lang: "sq",
        deprecated: true,
      }, //518 Android 11 Firefox Albanian
      {
        name: "Cantonese (Hong Kong)",
        voiceURI: "moz-tts:android:yue_HK",
        lang: "yue-HK",
        gender: "female",
      }, //519 Android 11 Firefox Cantonese (Hong Kong) - unused
      {
        name: "English (India)",
        voiceURI: "moz-tts:android:en_IN",
        lang: "en-IN",
        gender: "female",
      }, //520 Android 11 Firefox English (India) - unused
      {
        name: "Spanish (United States)",
        voiceURI: "moz-tts:android:es_US",
        lang: "es-US",
        gender: "female",
      }, //521 Android 11 Firefox Spanish (United States)
      {
        name: "Javanese (Indonesia)",
        voiceURI: "moz-tts:android:jv_ID",
        lang: "jv-ID",
        gender: "female",
      }, //522 Android 11 Firefox Javanese (Indonesia) - unused
      {
        name: "Latin",
        voiceURI: "moz-tts:android:la",
        lang: "la",
        deprecated: true,
      }, //523 Android 11 Firefox Latin
      {
        name: "Indonesian (Indonesia)",
        voiceURI: "moz-tts:android:in_ID",
        lang: "in-ID",
        gender: "female",
      }, //524 Android 11 Firefox Indonesian (Indonesia)
      {
        name: "Telugu (India)",
        voiceURI: "moz-tts:android:te_IN",
        lang: "te-IN",
        gender: "female",
      }, //525 Android 11 Firefox Telugu (India) - unused
      {
        name: "Romanian (Romania)",
        voiceURI: "moz-tts:android:ro_RO",
        lang: "ro-RO",
        gender: "female",
      }, //526 Android 11 Firefox Romanian (Romania)
      {
        name: "Catalan",
        voiceURI: "moz-tts:android:ca",
        lang: "ca",
        gender: "female",
      }, //527 Android 11 Firefox Catalan - unused
      {
        name: "English (United Kingdom)",
        voiceURI: "moz-tts:android:en_GB",
        lang: "en-GB",
        gender: "female",
      }, //528 Android 11 Firefox English (United Kingdom)
      {
        name: "Rishi",
        voiceURI: "com.apple.ttsbundle.Rishi-compact",
        lang: "en-IN",
        gender: "male",
      }, //529 iOS14 Rishi Indian English - unused
    ];

    self.iOS = /(iPad|iPhone|iPod)/g.test(navigator.userAgent);
    self.iOS9 = /(iphone|ipod|ipad).* os 9_/.test(
      navigator.userAgent.toLowerCase()
    );
    self.iOS10 = /(iphone|ipod|ipad).* os 10_/.test(
      navigator.userAgent.toLowerCase()
    );
    self.iOS11 = /(iphone|ipod|ipad).* os 11_/.test(
      navigator.userAgent.toLowerCase()
    );
    self.iOS11plus = /(iphone|ipod|ipad).* os 1[1-9]/.test(
      navigator.userAgent.toLowerCase()
    );
    self.iOS9plus = /(iphone|ipod|ipad).* os 10_/.test(
      navigator.userAgent.toLowerCase()
    );
    self.iOS12_0 = /(iphone|ipod|ipad).* os 12_0/.test(
      navigator.userAgent.toLowerCase()
    );
    self.iOS12 = /(iphone|ipod|ipad).* os 12_/.test(
      navigator.userAgent.toLowerCase()
    );

    self.iOS14plus = /(iphone|ipod|ipad).* os 1[4-9]/.test(
      navigator.userAgent.toLowerCase()
    );

    self.iOS20plus = /(iphone|ipod|ipad).* os [2-9][0-9]/.test(
      navigator.userAgent.toLowerCase()
    );
    ...
    self.logger = null;
    self.multipartUrlListener = null;
    ...
    self.init = function () {
      ...
      if (self.is_android || self.iOS || self.is_safari) self.useTimer = true;
      ...
      if (self.is_opera || typeof speechSynthesis === "undefined") {
        ...
        setTimeout(function () {
          var gsvinterval = setInterval(function () {
            ...
            if (
              v.length == 0 &&
              (self.systemvoices == null || self.systemvoices.length == 0)
            ) {
              //Needs to be output
    ...
    self.enableFallbackMode = function () {
      console.log("<----enableFallbackMode------->");
    ...
    self.setLogger = function (x) {
      self.logger = x || {};
    };

    self.setMultiPartListener = function (y){
      self.multipartUrlListener = y || {};
    };

    self.download = function (x) {
    ...
    self.speak = function (text, voicename, parameters) {
      ...
      if (self.rvsMapped) {
        ...
        self.logger.onlog("speak Func is called");
        ...
        if (voicename == null) {
          ...
          self.logger.onlog(voicename);
          rv = self.getResponsiveVoice(voicename);
          self.logger.onlog(rv);
        }
              ...
              for (var i = 0; i < words.length; i++) {
                ...
                if (part.length + words[i].length + 1 > self.CHARACTER_LIMIT) {
                  if (words[i].length >= self.CHARACTER_LIMIT) {
                    ...
                    part += words[i].substr(
                      0,
                      self.CHARACTER_LIMIT - part.length - 1
                    );
                    break;
                  } else {
        ...
        self.logger.onlog(navigator.userAgent.toLowerCase());
        ...
        for (var i = 0; i < multipartText.length; i++) {
          if (
            !self.fallbackMode &&
            self.getServiceEnabled(self.services.NATIVE_TTS)
          ) {
            //console.log("<----------SpeechSynthesis mode-------------->");
            self.logger.onlog("<----------SpeechSynthesis mode-------------->");
            //Use SpeechSynthesis
            ...
            msg.volume = self.selectBest([
              profile.collectionvoice.volume,
              profile.systemvoice.volume,
              1,
            ]); // 0 to 1
            msg.rate = self.selectBest([
              self.iOS9plus ? 1 : null,
              profile.collectionvoice.rate,
              profile.systemvoice.rate,
              defaultRate,
            ]); // 0.1 to 10 ** override iOS 0.25 rate
            msg.pitch = self.selectBest([
              profile.collectionvoice.pitch,
              profile.systemvoice.pitch,
              1,
            ]); //0 to 2*/
            msg.text = multipartText[i];
            msg.lang = self.selectBest([
            ...
            if (parameters != null) {
              msg.voice =
                typeof parameters.voice !== "undefined"
                  ? parameters.voice
                  : profile.systemvoice;
              ...
              msg.pitch =
                parameters.pitch != null ? parameters.pitch : msg.pitch;
              if (self.iOS) {
                msg.rate =
                ...
                msg.rate =
                  (parameters.rate != null ? parameters.rate : defaultRate) *
                  msg.rate;
              }

              msg.volume =
                parameters.volume != null ? parameters.volume : msg.volume;
            } else {
            ...
            self.fallbackMode &&
            self.getServiceEnabled(self.services.FALLBACK_AUDIO)
          ) {
            // console.log(
            //   "<-----------fallback mode-------------->",
            //   self.fallbackMode,
            //   self.getServiceEnabled(self.services.FALLBACK_AUDIO)
            // );
            self.logger.onlog("<-----------fallback mode-------------->");

            serviceUsed = self.services.FALLBACK_AUDIO;

            self.fallback_playbackrate = self.def_fallback_playbackrate;

            var pitch = self.selectBest([
              profile.collectionvoice.pitch,
              profile.systemvoice.pitch,
              1,
            ]); //0 to 2*/
            var rate = self.selectBest([
              self.iOS9plus ? 1 : null,
              profile.collectionvoice.rate,
              profile.systemvoice.rate,
              1,
            ]); // 0.1 to 10 ** override iOS 0.25 rate
            var volume = self.selectBest([
              profile.collectionvoice.volume,
              profile.systemvoice.volume,
              1,
            ]); // 0 to 1
            ...
            if (parameters != null) {
              ...
              volume =
                (parameters.volume != null ? parameters.volume : 1) * volume;
            ...
            var urlParams =
              "?t=" +
              encodeURIComponent(multipartText[i]) +
              "&tl=" +
              (profile.collectionvoice.lang ||
                profile.systemvoice.lang ||
                "en-US") +
              "&sv=" +
              (profile.collectionvoice.service ||
                profile.systemvoice.service ||
                "") +
              "&vn=" +
              (profile.collectionvoice.voicename ||
                profile.systemvoice.voicename ||
                "") +
              "&pitch=" +
              pitch.toString() +
              "&rate=" +
            ...
            if (typeof rvApiEndpoint != "undefined" && rvApiEndpoint) {
              console.log("param for fallback API");
              urlParams =
                "?text=" +
                encodeURIComponent(multipartText[i]) +
                "&lang=" +
            ...
            if (profile.collectionvoice.gender !== undefined)
            ...
            self.logger.onlog("URI>>>>>>>>>>>>>>>>> : "+ url);
            if(self.iOS14plus || self.iOS20plus){
              self.multipartUrlListener.onUrlReceived("URL"+ url);
            }
        ...
        if (
          ...
          self.logger.onlog(
            "fallback_startPart is called with fallbackChunkIndex=0"
          );
          if(self.iOS14plus || self.iOS20plus){
            self.multipartUrlListener.onUrlReceived("END");
          }else{
            self.fallbackChunkIndex = 0;
            self.fallback_startPart();
          }
          self.logger.onlog("URI>>>>>>>>>>>>>>>>> END>>> Size"+ self.fallbackChunks.length);
        }
    ...
    self.startTimeout = function (text, callback) {
      ...
      self.timeoutId = setTimeout(
        callback,
        self.getEstimatedTimeLength(text, multiplier)
      );
    ...
    self.speech_onend = function () {
      ...
      if (
        ...
        self.logger.onlog("onEnd if");
        self.log("Speech on end called  -" + self.msgtext);
        self.logger.onlog("Speech on end called  -" + self.msgtext);
        self.msgparameters.onendcalled = true;
        self.msgparameters.onend();
      } else {
        self.logger.onlog("onEnd else");
      }
    };
    ...
    self.speech_onstart = function () {
      ...
      self.logger.onlog("speech_onstart");
    };

    self.fallback_startPart = function () {
      self.logger.onlog("<---------fallback_startPart------->");
      if (self.fallbackChunkIndex == 0) {
        self.logger.onlog("speech_onstart fired from fallback_startPart");
        self.speech_onstart();
      }
      ...
      //console.log(self.fallbackChunks[self.fallbackChunkIndex].audio);
      ...
      if (self.fallback_audio == null) {
        ...
        (function () {
          ...
          var setAudioPlayingCheck = function (audio) {
            self.logger.onlog("<----------Audio Playing-------------->");
            setTimeout(function () {
          ...
          if (audio.readyState >= 2) {
            self.logger.onlog("<-----audio.readyState >= 2------>");
            audio.play();
            setAudioPlayingCheck(audio);
          } else {
            self.logger.onlog("<-----audio.readyState >= 2 Else------>");
            var canPlay = function () {
              self.logger.onlog("SRC>>>>>>>>>>>>>>>>>" + audio.src);
              audio.play();
              audio.removeEventListener("canplaythrough", canPlay);
            };
            audio.addEventListener("canplaythrough", canPlay, false);
        ...
        self.fallback_audio.onerror = function (e) {
          self.logger.onlog("<--------fallback_audio.onerror--------->");
        ...
        self.logger.onlog("<------fallback_finishPart ended event added----->");

        if (self.enableEstimationTimeout && self.useTimer) {
          self.logger.onlog("<------Timeout for fallback_finishPart----->");
          self.startTimeout(
            self.multipartText[self.fallbackChunkIndex],
            self.fallback_finishPart
          );
        }
      }
      self.logger.onlog("<---------fallback_startPart Finished------->");
    };
    ...
    self.isFallbackAudioPlaying = function () {
      ...
      for (c = 0; c < self.fallback_audiopool.length; c++) {
        ...
        if (
          ...
          //   self.logger.onlog(
          //     "<---------isFallbackAudioPlaying notPlaying------->" + c
          //   );
        } else {
          //   self.logger.onlog(
          //     "<---------isFallbackAudioPlaying Playing------->" + c
          //   );
          return true;
        }
      }
      self.logger.onlog("<---------isFallbackAudioPlaying Finished------->");
      return false;
    };

    self.fallback_finishPart = function (e) {
      self.logger.onlog("fallback_finishPart");
      /**
      ...
      if (self.isFallbackAudioPlaying()) {
        ...
        self.timeoutId = setTimeout(
          self.fallback_finishPart,
          (self.fallback_audio.duration - self.fallback_audio.currentTime) *
            1000
        );
        return;
      }
      ...
      if (self.fallbackChunkIndex < self.fallbackChunks.length - 1) {
        ...
        self.logger.onlog(
          "fallback_startPart is called from fallback_finishPart"
        );
        self.fallback_startPart();
      } else {
        //self.log('msg ended');
        self.logger.onlog("msg ended fallback_finishPart");
        self.speech_onend();
      }
    };
    ...
    self.mapRVs = function () {
      var browserLanguage = (function () {
        if ("object" == typeof navigator) {
          ...
          return (
            ...
            c && c.length
              ? c
              : (a = b["l" + a] || b["browserL" + a] || b["userL" + a])
              ? [a]
              : a
          );
        }
      ...
      for (var i = 0; i < self.responsivevoices.length; i++) {
        ...
        for (var j = 0; j < rv.voiceIDs.length; j++) {
          ...
          //vcoll.fallbackvoice = false;
          if (vcoll.fallbackvoice != true) {
            console.log("vcoll.fallbackvoice: ", vcoll.fallbackvoice);
            ...
            if (self.iOS12_0) {
              ...
              if (
                rv.lang.toLowerCase() != browserLanguage.toLowerCase() &&
                rv.lang.toLowerCase().split("-")[0] !=
            ...
            console.log(
              "Mapped " + rv.name + " to " + vcoll.lang + " fallback voice"
            );
            break;
          }
        }
    ...
    self.getSystemVoice = function (name) {
      ...
      var unicodeWhiteSpace = String.fromCharCode(160),
        encodedName = name.replace(
          new RegExp("\\s+|" + unicodeWhiteSpace, "g"),
          ""
        );

      if (
        typeof self.systemvoices === "undefined" ||
        self.systemvoices === null
      ) {
        return null;
      }
      ...
      for (var i = 0; i < self.systemvoices.length; i++) {
        ...
        if (
          0 ===
          self.systemvoices[i].name
            .replace(new RegExp("\\s+|" + unicodeWhiteSpace, "g"), "")
            .replace(/ *\([^)]*\) */g, "")
            .localeCompare(encodedName)
        ) {
          return self.systemvoices[i];
        }
      }
    ...
    self.getResponsiveVoice = function (name) {
      console.log("<----getResponsiveVoice--->");
      for (var i = 0; i < self.responsivevoices.length; i++) {
        if (self.responsivevoices[i].name == name) {
          console.log(self.responsivevoices[i].name);
          ...
          if (
            self.responsivevoices[i].mappedProfile.collectionvoice
              .fallbackvoice === true ||
            self.forcedFallbackMode === true
          ) {
            self.fallbackMode = true;
    ...
    self.RemoveEventListener = function (name, callback) {
      if (
        self[name + "_callbacks"] &&
        self[name + "_callbacks"].indexOf(callback) != -1
      ) {
        self[name + "_callbacks"].splice(
          self[name + "_callbacks"].indexOf(callback),
          1
        );
      }
    };
    ...
    self.clickEvent = function () {
      ...
      self.initializePermissionsTimeout = setTimeout(
    ...
    self.initFallbackPool = function () {
      self.logger.onlog("#####initFallbackPool#####>");
        ...
        for (var i = 0; i < poolLength; i++) {
          (function (i) {
            ...
            if (self.iOS) {
              audio.src = silentAudioSrc;
              audio.load();
              self.logger.onlog("iteration: " +i);
              self.logger.onlog(audio.src);
              ...
              if (i == poolLength - 1) {
                ...
                self.logger.onlog("iOS HTML audio initialized");
                self.iOS_initialized = true;
              }
            }
    ...
    self.allowSpeechClicked = function (value) {
      self.logger.onlog("<---allowSpeechClicked--> " + value);
      ...
      if (value) {
        ...
        if (self.scheduledSpeak) {
          self.speak(
            self.scheduledSpeak.text,
            self.scheduledSpeak.voicename,
            self.scheduledSpeak.parameters
          );
    ...
    self.checkSpeechAllowed = function (options) {
      ...
      if (self.speechAllowedByUser == false) {
        self.logger.onlog("<---speechAllowedByUser-denied--->");
        return false;
      }
      ...
      var onSafariFallback =
        self.is_safari && (self.fallbackMode || self.forcedFallbackMode);
      var shouldShowPopup =
        self.disablePermissionPopup !== true &&
        (self.allowPermissionPopupEverywhere === true ||
          onMobile ||
          onSafariFallback ||
          self.speechSynthesisNotAllowedError === true);
      if (shouldShowPopup && !self.click_event_detected) {
        //self.enableWindowClickHook();
        self.logger.onlog("<---speechAllowedByUser Allow Audio poppedUP--->");
        if (self.allowSpeechDiv) return;

        self.allowSpeechDiv_appearances =
          self.allowSpeechDiv_appearances == null
            ? 1
            : ++self.allowSpeechDiv_appearances;
        if (self.allowSpeechDiv_appearances > 2) {
          self.logger.onlog(
            "<---speechAllowedByUser still not Allowed by user--->"
          );
    ...
    self.fallback_audioPool_getAudio = function () {
      self.logger.onlog("<----fallback_audioPool_getAudio--->");
      self.initFallbackPool();
    ...
    self.fallback_updateChunksBuffer = function () {
      ...
      self.logger.onlog("<-----fallback_updateChunksBuffer-------->");
      for (
        var i = self.fallbackChunkIndex;
        i <
        Math.min(
          self.fallbackChunks.length,
          self.fallbackChunkIndex + self.fallbackBufferLength
        );
        i++
      ) {
        ...
        if (c.audio == null) {
          ...
          (function (c) {
            var loadChunk = function () {
              ...
              self.logger.onlog("============================> loading complete");
              self.logger.onlog(c.audio.src);
            };
            if (i == 0) {
              loadChunk(); // Load now
            } else {
    ...
    self.numToWords = function (n) {
      ...
      var chunk = function chunk(n) {
        return function (xs) {
          return isEmpty(xs)
            ? []
            : [take(n)(xs)].concat(_toConsumableArray(chunk(n)(drop(n)(xs))));
        };
      };
    ...
    self.getWords = function (text) {
      //Process currencies
      text = text.replace(
        /$|Â¥|â‚¡|â‚¬|Â£|â‚ª|â‚¹|ï¿¥|áŸ›|â‚©|â‚¦|à¸¿|â‚´|â‚«/gi,
        " dummy currency "
      );
    ...
    self.getEstimatedTimeLength = function (text, multiplier) {
      var words = self.getWords(text),
        ...
        multiplier =
          multiplier ||
          1; /*, minWordLengthInText = 0, maxWordLengthInText = 0*/

      words.map(function (word, i) {
        charsCount += (word.toString().match(/[^ ]/gim) || word).length;
      ...
      var estimatedLength =
        multiplier * 1000 * (60 / self.WORDS_PER_MINUTE) * wordsCount; /** wlf*/
        ...
        for (var i = 0; i < textReplacements.length; i++) {
          ...
          if (collectionvoices) {
            ...
            if (
              ...
              collectionvoices.indexOf(profile.collectionvoice.name) != -1
            ) {
          ...
          if (systemvoices) {
            ...
            if (
              profile.systemvoice &&
              profile.systemvoice.name &&
              systemvoices.indexOf(profile.systemvoice.name) != -1
            ) {
          ...
          if (
            (collectionvoices == null ||
              (collectionvoices != null && collectionVoicesMatch)) &&
            (systemvoices == null ||
              (systemvoices != null && systemVoicesMatch))
          ) {
